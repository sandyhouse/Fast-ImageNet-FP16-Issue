...
def parse_args():
    ...
    add_arg('data_dir',         str,   "../fast_resnet_data",  "The ImageNet dataset root dir.")
    add_arg('model_category',   str,   "models",             "Whether to use models_name or not, valid value:'models','models_name'" )
    add_arg('fp16',             bool,  False,                "Enable half precision training with fp16." )
    #add_arg('scale_loss',       float, 1.0,                  "Scale loss for fp16." )
    add_arg('scale_loss',       float, 8.0,                  "Scale loss for fp16." )
    # for distributed
    add_arg('update_method',    str,    "nccl2",            "Can be local, pserver, nccl2.")
    ...
    add_arg('memory_optimize',  bool,   False,               "Whether to enable memory optimize.")
...
def build_program(args,
        ...
        with fluid.unique_name.guard():
            ...
            if is_train:
                ...
                if args.fp16:
                    ...
                    #print("params_grads: {}".format(params_grads))
                    #print("master_params_grads: {}".format(master_params_grads))
    ...
    # print("py_reader_startup_prog:")
    # program_to_code(py_reader_startup_prog)
    # print("startup_prog:")
...
def refresh_program(args,
    ...
    train_args = build_program(args, True, train_prog, startup_prog,
                               py_reader_startup_prog, sz, trn_dir, 
                               bs, min_scale)
    ...
    if args.update_method == "nccl2":
        nccl2_prepare(args, py_reader_startup_prog, main_prog=train_prog)
    ...
    #    True, main_program=test_prog, share_vars_from=train_exe, exec_strategy=strategy, build_strategy=build_strategy, num_trainers=num_trainers, trainer_id=trainer_id)
